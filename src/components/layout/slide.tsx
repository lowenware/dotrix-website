  ...
  return (
    <>
      {size === "large" && (
        ...
        >
          <div
            className={classNames(stretch, "h-screen bg-dark opacity-75")}
          ></div>
          <div
            className={classNames("flex justify-center items-center", stretch)}
          >
            {children}
          </div>
        </div>
      ...
      {size === "small" && (
        <div
          className="relative h-30vh overflow-hidden bg-fixed
