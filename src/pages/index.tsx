...
import { Footer, JoinUs, NewsList, TopBar } from "../components";
  ...
  return (
    <>
      <div className="flex flex-col">
        <TopBar />
        <div className="home__image w-full h-60.6 sm:h-80.8 bg-fixed items-center justify-center bg-no-repeat bg-cover">
          <div className="bg-opacity-70 flex flex-col bg-black-100 h-60.6 sm:h-80.8 bg-fixed w-full">
            <section className="my-auto">
              <div className="">
                <p className="text-white text-32 md:text-72 mb-24 text-center">
                  Program your world
                </p>
                <p className="text-white text-12 md:text-24 mb-70 text-center">
                  OpenSource 3D engine for Rust developers
                </p>
              </div>
              <div className="flex flex-col sm:flex-row self-center w-2/3 mx-auto justify-center">
                <Link href="">
                  <p className="flex mb-16 sm:mb-0 justify-center sm:ml-32 lg:ml-0 lg:mr-4 items-center text-white py-8 sm:px-16 sm:py-8 md:py-16 md:px-24 font-bold cursor-pointer text-18 lg:text-24 bg-blue-light hover:bg-black-200 hover:bg-opacity-25 duration-500 rounded-xl">
                    GET STARTED
                  </p>
                </Link>

                <Link href="">
                  <div className="sm:ml-40 lg:ml-32  flex justify-center items-center py-8 pr-8 sm:py-16 sm:pl-20 sm:pr-32 border hover:bg-black-200 hover:bg-opacity-25 duration-500 cursor-pointer border-white rounded-xl">
      ...
      <section className="w-full bg-black-800 flex justify-center">
        <div className="max-w-7xl grid md:gap-32 grid-cols-1 sm:grid-rows-2 sm:grid-cols-2 mb-64">
          ...
          <div className="flex flex-col pt-8 px-32 sm:pl-32">
            <p className="text-white font-bold text-24 mb-12">Crossplatform</p>
            <p className="text-white">
